...
return [
    ...
    */
    ...
    'standard' => [
        ...
        ['from' => 12500001,    'to' => 25000000,  'rate' => 2,  'description' => '£125,001 to £250,000'],
        ['from' => 25000001,    'to' => 92500000,  'rate' => 5,  'description' => '£250,001 to £925,000'],
        ['from' => 92500001,    'to' => 150000000, 'rate' => 10, 'description' => '£925,001 to £1,500,000'],
        ['from' => 150000001,   'to' => null,       'rate' => 12, 'description' => 'Over £1,500,000'],
    ],
    ...
    'first_time_buyer' => [
        ...
        'bands' => [
            ...
            ['from' => 30000001, 'to' => 50000000, 'rate' => 5, 'description' => '£300,001 to £500,000'],
        ],
    ],
